...
<footer className="fixed bottom-0 bg-black opacity-70 rounded-lg shadow m-4 dark:bg-gray-800">
    ...
    <ul className="flex flex-wrap items-center mt-3 ml-5 text-sm font-medium text-white dark:text-gray-400 sm:mt-0">
        <li>
            <a href="/about/sobre" className="mr-4 hover:underline md:mr-6 ">Sobre</a>
        </li>
        <li>
            <a href="/about/privacidade" className="mr-4 hover:underline md:mr-6">Políticas De Privacidade</a>
        </li>
        <li>
            <a href="/about/licenciamento" className="mr-4 hover:underline md:mr-6">Licenciamento</a>
        </li>
        <li>
            <a href="/about/contato" className="hover:underline">Contato</a>
        </li>
    </ul>
    </div>
</footer>
