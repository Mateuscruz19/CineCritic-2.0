  ...
  return (
   ...
   //   </aside>
     ...
     <div className="top-0 z-40 w-64 h-[57rem]">
         <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800 flex flex-col items-center bg-opacity-40 rounded-md">
         <a href="/pages/dashboard/home" className="mr-3 sm:h-7 items-center pl-2.5 mb-5">
         <Image src="/images/logos/logo2.png" alt="CineCritic Logo" width="160" height="160"/>
      </a>
      <div className="w-52 h-5/6 mt-20 flex flex-col justify-between">
      <ul className="space-y-2 font-medium mr-8">
         <li>
