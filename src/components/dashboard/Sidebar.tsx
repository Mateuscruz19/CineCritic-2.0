...
export default function Sidebar(props:any) {
   const [open, setOpen] = useState(true);
    ...
    return (<>
<aside id="logo-sidebar"className="bg-[#111827] top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div className="h-full px-3 py-4 overflow-y-autobg-gray-800">
      <a href="/pages/dashboard/home" className="flex items-center pl-2.5 mb-5 border-r">
         <img src="/images/logos/logo5.png" className="h-6 mr-3 sm:h-7" alt="CineCritic Logo"/>
      ...
      <ul className="space-y-2 font-medium mt-8">
         <li>
            <a href="#" className="flex items-center p-2  rounded-lg text-white hover:bg-gray-700">
               <svg aria-hidden="true" className="w-6 h-6 transition duration-75 text-white group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
         ...
         <li>
            <a href="#" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700">
               ...
               <span className="flex-1 ml-3 whitespace-nowrap">Bônus</span>
               <span className="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-white bg-[#FF5757] rounded-full">Pro</span>
            </a>
         </li>
         <li>
         <a href="#" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700">
         ...
         <a href="#" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700">
               ...
               <span className="flex-1 ml-3 whitespace-nowrap">Listas</span>
            </a>
         </li>
         <li>
          {props.online ? <a href="#" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700">
