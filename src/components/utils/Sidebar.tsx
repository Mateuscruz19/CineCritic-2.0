  ...
  return (
     ...
     <div className=" z-40 w-64 h-[95%]">
      ...
      <ul className="space-y-2 font-medium">
         <li>
            <a href="/dashboard/home" className="flex items-center p-2  rounded-lg text-white hover:bg-gray-700">
         ...
         <li>
            <a href="/dashboard/popular" className="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700">
         ...
         <li>
         <a href="/dashboard/genero" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700">
         ...
         <li>
         <a href="/dashboard/perfil" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700">
               <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-white transition duration-75  group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd"></path></svg>
               <span className="flex-1 ml-3 whitespace-nowrap">Perfil</span>
            </a>
         </li>
         <li>
          <a className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700" onClick={() => signOut({ callbackUrl: '/' })}>
